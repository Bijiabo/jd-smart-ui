...
var rules = {
    themeColor: function themeColor(value) {
        return ['.active-block { background-color: ' + value + ' !important}', '.active-text { color: ' + value + ' !important}', '.active-border { border-color: ' + value + ' !important}', '.theme-block { background-color: ' + value + ' !important}', '.theme-text { color: ' + value + ' !important}', '.theme-border { border-color: ' + value + ' !important}'];
    }
};
